...
namespace FatherShopImperiyaOdyagu.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CreatedDate,Photo,Title,Description,CategoryId")] Product product, IFormFile photo)
        {
            if (photo != null)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CreatedDate,Photo,Title,Description,CategoryId")] Product product, IFormFile photo)
        {
            if (photo != null)
            {
                string b64 = string.Empty;
